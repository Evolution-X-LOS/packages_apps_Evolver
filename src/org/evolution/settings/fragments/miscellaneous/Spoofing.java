...
public class Spoofing extends SettingsPreferenceFragment implements
    ...
    private static final String SYS_GMS_SPOOF_APP = "persist.sys.pihooks.enable";
    ...
    private SystemPropertySwitchPreference mGmsSpoofApp;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGmsSpoofApp = (SystemPropertySwitchPreference) findPreference(SYS_GMS_SPOOF_APP);
        ...
        boolean isPiApkEnabled = SystemProperties.getBoolean(SYS_GMS_SPOOF_APP, false);
        ...
        if (isPixelGmsEnabled) {
            mGmsSpoofApp.setEnabled(false);
        } else if (isPiApkEnabled) {
            mGmsSpoof.setEnabled(false);
        }

        mGmsSpoof.setOnPreferenceChangeListener(this);
        mGmsSpoofApp.setOnPreferenceChangeListener(this);
